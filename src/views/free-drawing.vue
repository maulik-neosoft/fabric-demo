<template>
    <div>
        ...
        <div style="display: inline-block; margin-left: 10px">
            <button @click="switchDrawingMode" ref="drawing-mode" id="drawing-mode" class="btn btn-info">Cancel drawing mode</button><br>
            <button @click="clearCanvas" ref="clear-canvas" id="clear-canvas" class="btn btn-info">Clear</button><br>
        </div>
    </div>
</template>
<script>
